    ...
    const handleAction = async (action: string, data: AdminActionData) => {
        ...
        try {
            ...
            if (action === "mint") {
                ...
                method = "mint";
                const scaledAmount = parseTokenAmount(mintData.amount, decimals);
                ...
                method = "clawback";
                const scaledAmount = parseTokenAmount(burnData.amount, decimals);
                ...
                const scaledAmount = parseTokenAmount(vestingData.amount, decimals);
